      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Roletas</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Gere roletas personalizadas para decisões, sorteios e diversão. 
              Escolha entre roletas pré-definidas ou crie suas próprias opções.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <span className="text-gray-300">❓ Sim ou Não</span>
              </li>
              <li>
                <span className="text-gray-300">🎮 Atividades</span>
              </li>
              <li>
                <span className="text-gray-300">🎲 Números</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Roletas. Todos os direitos reservados.
          </p>
